      ...
      <div class="container-fluid">
        ...
        if($_SERVER['REQUEST_METHOD'] == "POST") {
          ...
          if($pencarian !='') {
            ...
            $query = "SELECT * FROM lokasi LIMIT $posisi,$batas";
            $queryJml ="SELECT * FROM lokasi";
            $no = $posisi + 1;
          }
        } else {
          $query = "SELECT * FROM lokasi LIMIT $posisi,$batas";
          ...
          while($data = mysqli_fetch_array($sql_ruang)){?>
            <tr>
              ...
              <td class="text-center">
                <a href="edit.php?id=<?=$data['id_lokasi']?>" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></a>
                <a href="del.php?id=<?=$data['id_lokasi']?>" onclick="return confirm('Yakin akan menghapus data?')" class="btn btn-sm bg-gradient-danger"><i class="fas fa-trash"></i></a>
                <a href="detail.php?id=<?=$data['id_lokasi']?>" class="btn btn-primary btn-sm"><i class="fas fa-map-marker-alt"></i></a>
