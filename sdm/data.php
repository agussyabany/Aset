          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                ...
                <h3 class="card-title">Master SDM Pendukung</h3>
          ...
          while($data = mysqli_fetch_array($sql_sdm)){?>
            <tr>
              ...
              <td class="text-center">
                <a href="edit.php?id=<?=$data['id_sdm']?>" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></a>
                <a href="del.php?id=<?=$data['id_sdm']?>" onclick="return confirm('Yakin akan menghapus data?')" class="btn btn-sm bg-gradient-danger"><i class="fas fa-trash"></i></a>
